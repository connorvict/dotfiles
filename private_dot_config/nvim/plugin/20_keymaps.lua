...
local nmap = function(lhs, rhs, desc)
	...
	vim.keymap.set("n", lhs, rhs, { desc = desc, unique = true })
end
...
nmap("ZZ", "<Cmd>wall<Bar>quitall<CR>", "Save all and quit")
...
local nmap_leader = function(suffix, rhs, desc)
  vim.keymap.set('n', '<Leader>' .. suffix, rhs, { desc = desc, unique = true })
end
local xmap_leader = function(suffix, rhs, desc)
  vim.keymap.set('x', '<Leader>' .. suffix, rhs, { desc = desc, unique = true })
end
...
nmap_leader('ft', '<Cmd>lua require("config.theme").pick()<CR>', 'Theme')
...
-- - `<Leader>dc` - continue/start a debug session
-- - `<Leader>db` - toggle breakpoint
-- - `<Leader>du` - toggle 'nvim-dap-view' UI
nmap_leader('db', '<Cmd>DapToggleBreakpoint<CR>', 'Toggle breakpoint')
nmap_leader('dB', '<Cmd>DapConditionalBreakpoint<CR>', 'Conditional breakpoint')
nmap_leader('dc', '<Cmd>DapContinue<CR>', 'Continue/start')
nmap_leader('di', '<Cmd>DapStepInto<CR>', 'Step into')
nmap_leader('dl', '<Cmd>DapRunLast<CR>', 'Run last')
nmap_leader('dm', '<Cmd>DebugMode<CR>', 'Debug mode')
nmap_leader('do', '<Cmd>DapStepOver<CR>', 'Step over')
nmap_leader('dO', '<Cmd>DapStepOut<CR>', 'Step out')
nmap_leader('dx', '<Cmd>DapTerminate<CR>', 'Terminate')
nmap_leader('du', '<Cmd>DapViewToggle<CR>', 'Toggle debug UI')
nmap_leader('dw', '<Cmd>DapViewWatch<CR>', 'Watch expression')

-- o is for 'Overseer'. Common usage:
-- - `<Leader>or` - run a task from a template
-- - `<Leader>ot` - toggle task list
-- - `<Leader>ow` - watch/run current file with custom command
nmap_leader('oa', '<Cmd>OverseerTaskAction<CR>', 'Task action')
nmap_leader('oc', '<Cmd>OverseerClose<CR>', 'Close task list')
nmap_leader('oo', '<Cmd>OverseerOpen<CR>', 'Open task list')
nmap_leader('or', '<Cmd>OverseerRun<CR>', 'Run task')
nmap_leader('os', '<Cmd>OverseerShell<CR>', 'Run shell command')
nmap_leader('ot', '<Cmd>OverseerToggle<CR>', 'Toggle task list')
nmap_leader('ow', '<Cmd>WatchRun<CR>', 'Watch/run current file')
...
nmap_leader('tt', '<Cmd>ToggleTerminal<CR>', 'Terminal (toggle)')
nmap_leader('tv', '<Cmd>vertical term<CR>', 'Terminal (vertical)')
vim.keymap.set('n', '<C-/>', '<Cmd>ToggleTerminal<CR>', { desc = 'Terminal (toggle)', unique = true })
vim.keymap.set('t', '<C-/>', '<C-\\><C-n><Cmd>ToggleTerminal<CR>', { desc = 'Terminal (toggle)', unique = true })
